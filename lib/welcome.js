...
export async function processWelcome(conn, { id, participants, action }) {
    try {
        ...
        for (const item of participants) {
            ...
            // Obtener el nombre del usuario (si conn.getName está disponible) o usar el número etiquetado (@12345)
            let userPushName = ''
            try {
            ...
            // Si no tiene pushName registrado, usar formato @número
            ...
            // Parámetros formateados para welcome-card
            ...
            if (action === 'add') {
                ...
                // 1. Intentar Primero con StellarWA
                try {
            ...
            if (action === 'remove') {
                ...
                // 1. Intentar Primero con StellarWA (Bye Image)
                try {
